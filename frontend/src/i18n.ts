...
export const copy = {
  en: {
    ...
    couponPopupTitle: 'Pick your coupon', couponPopupEyebrow: 'GIFT',
    couponPopupBody: 'Claim one of our available coupons and use it on the shop tab — prices update instantly.',
    couponClaimCta: 'Claim', couponDeclineCta: 'Maybe later',
    couponFloating: 'Get coupon', couponClaimedToast: 'Coupon claimed — discount active on shop!',
    couponAlreadyClaimed: 'You already have this coupon active.',
    couponClaimFailed: 'Could not claim this coupon. Please try again.',
    couponListEmpty: 'No coupons available right now. Check back soon!',
    couponRemaining: '{n} left',
    couponSoldOut: 'Sold out',
    couponActiveBadge: 'Active',
    couponBannerEyebrow: 'COUPON ACTIVE', couponBannerTitle: 'You\'re saving',
    couponBannerSub: 'applied to every product below', couponBannerRemove: 'Remove coupon',
    couponBadge: '15% OFF', couponOriginal: 'was',
    couponLinkHome: 'Claim 15% off coupon', couponActiveHome: 'Coupon active — 15% off',
    couponStripTitle: 'Welcome gift — 15% off everything', couponStripSub: 'Tap to claim your coupon and use it on the shop tab.',
    couponStripActiveSub: 'Your coupon is active on the shop tab.',
  },
  zh: {
    ...
    adminLowStock: '库存偏低',
    couponPopupTitle: '选择你的优惠券', couponPopupEyebrow: '礼物',
    couponPopupBody: '领取一张可用优惠券，在商品页面使用 — 价格会即时更新。',
    couponClaimCta: '领取', couponDeclineCta: '稍后再说',
    couponFloating: '领券', couponClaimedToast: '优惠券已领取 — 折扣已在商品页面生效！',
    couponAlreadyClaimed: '这张优惠券你已经在使用了。',
    couponClaimFailed: '领取失败，请稍后再试。',
    couponListEmpty: '目前没有可用优惠券，请稍后再来！',
    couponRemaining: '剩余 {n} 张',
    couponSoldOut: '已领完',
    couponActiveBadge: '使用中',
    couponBannerEyebrow: '优惠券生效中', couponBannerTitle: '你正在省下',
    couponBannerSub: '已应用到下方所有商品', couponBannerRemove: '取消优惠券',
    couponBadge: '15% 折扣', couponOriginal: '原价',
    couponLinkHome: '领取 15% 优惠券', couponActiveHome: '优惠券生效中 — 15% 折扣',
    couponStripTitle: '欢迎礼物 — 全场 15% 折扣', couponStripSub: '点击领取优惠券，在商品页面使用。',
    couponStripActiveSub: '你的优惠券已在商品页面生效。',
  }
} as const
